module.exports = ({ theme }) => ({
  DEFAULT: {
    css: {
      '--tw-prose-body': 'var(--brand-text-soft)',
      '--tw-prose-headings': 'var(--brand-text)',
      '--tw-prose-links': 'var(--brand-accent)',
      '--tw-prose-links-hover': 'var(--brand-primary)',
      '--tw-prose-links-underline': 'rgba(0, 117, 74, 0.35)',
      '--tw-prose-bold': 'var(--brand-text)',
      '--tw-prose-counters': 'rgba(0, 0, 0, 0.58)',
      '--tw-prose-bullets': 'rgba(0, 0, 0, 0.22)',
