...
export const description =
  'State management in React: when to use local state, context, reducers, and external stores in production applications.';
...
<Expand parent={<>1. UI state <span style={{ fontSize: '0.75rem' }}>(other names: "Control State")</span> </>}>
...
<Expand parent={<>2. Communication state <span style={{ fontSize: '0.75rem' }}>(other names: "Fetch State", "Async State")</span></>}>
...
<Expand parent={<>3. Application state <span style={{ fontSize: '0.75rem' }}>(other names: "Business Data", "App Data", "Server State")</span></>}>
...
<Expand parent={<>4. Session state <span style={{ fontSize: '0.75rem' }}>(other names: "Authentication State")</span></>}>
...
<Expand parent={<>5. Location state <span style={{ fontSize: '0.75rem' }}>(other names: "URL", "Browser History State", "Navigation State")</span></>}>
...
Thanks for reading! If you have any suggestions on how developers can approach managing state in their React applications, <Resource url="/team/mohamed-elshahawy">let's talk</Resource> (You will get credit for your contributions!).
