...
export const description = 'Master React Hooks with practical patterns for useState, useEffect, useMemo, useRef, and performance-safe hook usage.'
...
<div className="not-prose my-6 overflow-hidden rounded-[12px] border border-[#2a2a2a] bg-[#0d1117] p-5 text-white">
  ...
  <div className="grid gap-3 md:grid-cols-2">
    <div className="rounded-[10px] border border-zinc-700 bg-[#111827] p-3">
      <p className="text-xs uppercase tracking-[0.08em] text-zinc-400">State</p>
      <p className="mt-1 text-sm text-zinc-100"><code>useState</code> for local state</p>
      <p className="mt-1 text-sm text-zinc-300"><code>useReducer</code> for complex transitions</p>
    </div>
    <div className="rounded-[10px] border border-zinc-700 bg-[#111827] p-3">
      <p className="text-xs uppercase tracking-[0.08em] text-zinc-400">Side Effects</p>
      <p className="mt-1 text-sm text-zinc-100"><code>useEffect</code> for async/effects</p>
      <p className="mt-1 text-sm text-zinc-300"><code>useLayoutEffect</code> only when layout measurement timing matters</p>
    </div>
    <div className="rounded-[10px] border border-zinc-700 bg-[#111827] p-3">
      <p className="text-xs uppercase tracking-[0.08em] text-zinc-400">References</p>
      <p className="mt-1 text-sm text-zinc-100"><code>useRef</code> for mutable values without re-render</p>
      <p className="mt-1 text-sm text-zinc-300"><code>useImperativeHandle</code> for controlled ref APIs</p>
    </div>
    <div className="rounded-[10px] border border-zinc-700 bg-[#111827] p-3">
      <p className="text-xs uppercase tracking-[0.08em] text-zinc-400">Performance</p>
      <p className="mt-1 text-sm text-zinc-100"><code>useMemo</code> for expensive derived values</p>
      <p className="mt-1 text-sm text-zinc-300"><code>useCallback</code> for stable callback identities</p>
    </div>
  </div>
  <div className="mx-auto my-3 h-5 w-px bg-zinc-700" />
  <div className="rounded-[10px] border border-emerald-700/60 bg-emerald-950/30 p-3 text-sm text-emerald-200">
