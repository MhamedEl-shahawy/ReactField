...
<div className="not-prose my-4 inline-flex items-center rounded-[3px] border border-[#dedbd6] bg-white px-2 py-1 text-[11px] text-[#626260]">
...
<div className="not-prose mt-8">
  <a href="/react-performance-optimization" className="text-[13px] font-medium text-[#ff5600] hover:underline">
