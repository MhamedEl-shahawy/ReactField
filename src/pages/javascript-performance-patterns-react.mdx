...
Fix guide:
- Inline style props -> hoist constant objects to module scope when static (same idea for **CSS Modules** or vanilla `className` strings: avoid allocating **new** style objects or template strings every render when the value is static)
