    ...
    <div className="not-prose">
      <PillTabs defaultValue="bulletproof">
        <PillTabsList>
          ...
          <PillTabsTrigger value="scale">scale-up</PillTabsTrigger>
        </PillTabsList>
        <PillTabsContent value="bulletproof">
          This directory structure is based on the{' '}
          <Resource url="https://github.com/MhamedEl-shahawy/React-Vite-Boilerplate">
        ...
        <PillTabsContent value="scale">
          This structure can be used for medium to large React applications,
          adapted from{' '}
          <Resource url="https://www.robinwieruch.de/react-folder-structure/">
            Robin Wieruch
          </Resource>{' '}
          - a high quality educator and content creator for in-depth tutorials
          and articles. Visit his blog{' '}
          <Resource url="https://www.robinwieruch.de/blog/">here</Resource>
          .
...
export function DirectoryExplorer({ structure }: DirectoryExplorerProps) {
  ...
  return (
    <div className="mt-8 mb-6 rounded-xl border p-4 shadow dark:border-zinc-700">
      <div className="flex gap-2">
        ...
        <div className="flex-grow rounded-r-lg border p-4 dark:border-zinc-700">
          {selectedItem && (
